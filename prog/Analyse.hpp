...
using namespace ba;
    ...
    // used to generate this class and read the Tree.
       if (tree == 0) {
          TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mc08.105941.McAtNlo0331_JIMMY_WpZ_lnull.merge.D3PD.e367_s462_r635_t53.root");
          if (!f) {
             f = new TFile("mc08.105941.McAtNlo0331_JIMMY_WpZ_lnull.merge.D3PD.e367_s462_r635_t53.root");
          }
          tree = (TTree*)gDirectory->Get("ControlSample0");
